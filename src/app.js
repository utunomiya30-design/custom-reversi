...
els.restart.addEventListener("click", startGame); els.back.addEventListener("click", () => { clearCpu(); els.play.classList.add("is-hidden"); els.result.classList.add("is-hidden"); els.setup.classList.remove("is-hidden"); scrollToPanel(els.setup); });
